...
from examples.wmt_2020.si_en.transformer_plus_config import TEMP_DIRECTORY, MODEL_TYPE, MODEL_NAME, \
...
if transformer_plus_config["reprocess_similarity"]:
    ...
    train_extended.to_csv("examples/wmt_2020/si_en/data/si-en/train.sien.df.short.extend.tsv", sep='\t', encoding="utf-8-sig", index=False)
    dev_extended.to_csv("examples/wmt_2020/si_en/data/si-en/dev.sien.df.short.extend.tsv", sep='\t',  encoding="utf-8-sig", index=False)
    test_extended.to_csv("examples/wmt_2020/si_en/data/si-en/test20.sien.df.short.extend.tsv", sep='\t',  encoding="utf-8-sig", index=False)
