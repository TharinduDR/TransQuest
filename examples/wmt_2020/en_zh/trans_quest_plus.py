...
if transformer_plus_config["reprocess_similarity"]:
    ...
    dev_extended.to_csv("examples/wmt_2020/en_zh/data/en-zh/dev.enzh.df.short.extend.tsv", sep='\t',  encoding="utf-8-sig", index=False)
    test_extended.to_csv("examples/wmt_2020/en_zh/data/en-zh/test20.enzh.df.short.extend.tsv", sep='\t',  encoding="utf-8-sig", index=False)
