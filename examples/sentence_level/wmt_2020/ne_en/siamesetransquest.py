...
from examples.sentence_level.wmt_2020.ne_en.siamesetransquest_config import TEMP_DIRECTORY, MODEL_NAME, \
...
TEST_FILE = "examples/sentence_level/wmt_2020/ne_en/data/ne-en/test20.neen.df.short.tsv"
