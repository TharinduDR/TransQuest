...
from examples.sentence_level.wmt_2020_task2.en_zh.monotransquest_config import TEMP_DIRECTORY, GOOGLE_DRIVE, DRIVE_FILE_ID, MODEL_NAME, \
...
format_submission(df=test, index=index, language_pair="en-zh", method="TransQuest", path=os.path.join(TEMP_DIRECTORY, SUBMISSION_FILE))